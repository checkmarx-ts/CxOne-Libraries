<#
 .Synopsis
  CheckmarxOne REST API Module for Powershell

 .Description
  A powershell module that can be used to connect to and manage a CheckmarxOne environment via REST API. Some parts require Powershell 6+.
